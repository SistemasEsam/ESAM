...
this.estate=change
    ...
    guardardatos(){
      ...
      const namelocal=this.local.name;
      const databaseref = db.ref(namelocal);

      try {
      this.formularios.forEach(formulario => {
        if (formulario.aquiexplaboral) {
          const formData = {
            nombreexplabo:formulario.nombreexplabo,
          comentexplaboral:formulario.comentexplaboral,
          cargoexplaboral:formulario.cargoexplaboral,
          aquiexplaboral:formulario.aquiexplaboral,
          inicioexplaboral:formulario.inicioexplaboral,
          paisexplaboral:formulario.paisexplaboral,
          ciudadexplaboral : formulario.ciudadexplaboral,
          nombreref:formulario.nombreref,
          apellidoref:formulario.apellidoref,
          cargoref:formulario.cargoref,
          numeroref:formulario.numeroref
          };
          ...
          cargoexplaboral:formulario.cargoexplaboral,
          aquiexplaboral:formulario.aquiexplaboral,
          incioexplaboraluno:formulario.incioexplaboraluno,
          finexplaboral : formulario.finexplaboral,
          paisexplaboral:formulario.paisexplaboral,
          ciudadexplaboral : formulario.ciudadexplaboral,
          nombreref:formulario.nombreref,
          apellidoref:formulario.apellidoref,
...
const formData={
  uniexpdoc: formulario2.uniexpdoc,
          materiaexpdoc: formulario2.materiaexpdoc,
          calidadexpdoc:formulario2.calidadexpdoc,
          gradoexpdoc:formulario2.gradoexpdoc,
          inicioexpdoc:formulario2.inicioexpdoc,
          finexpdoc:formulario2.finexpdoc,
...
databaseref.push(formData)
    ...
    eliminarFormulariorefe(index3) {
      this.references.splice(index3, 1);
    }
  }
}
</script>
