...
import configuno from '../config'
import 'firebase/storage'

let app = firebase.initializeApp(configuno);
  ...
  { name: "Ecuador", code: "EC" },
    ...
    methods: {
      ...
      uploadimagen(){
        ...
        const newname = this.numberDoc+this.nombres+this.apellidoPaterno;
        const fileref = storageref.child(newname+'/imagen/'+this.file.name);
      ...
      submitForm() {
        ...
        const newnametres=this.numberDoc+this.nombres+this.apellidoPaterno
        const websistemRef=db.ref(newnametres);

   websistemRef.push({
     name :this.nombres,
     apellidop: this.apellidoPaterno,
     apellidom: this.apellidoMaterno,
     contacu:this.contactouno,
     contacd:this.contactodos,
     mail:this.email,
     country:this.selectedCountry,
     radicationCity:this.cityRadication,
     dir:this.addres,
     docutype:this.selectedDocumentType,
     docni:this.numberDoc,
     birth:this.dateOfBirth,
     gene:this.gender,
     urlimg:this.file.name,
     ruta:this.numberDoc+this.nombres+this.apellidoPaterno
...
const dataToSave = {
        name: this.numberDoc+this.nombres+this.apellidoPaterno, // Guardar solo el dato 'name'
      };
